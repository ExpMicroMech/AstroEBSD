...
The main repository can be found https://github.com/ExpMicroMech/AstroEBSD/

The paper describing the basic AstroEBSD work can be found in: 
...
...with EDS for phase identification:

Thomas McAuliffe, Alex Foden, Chris Bilsland, Dafni Daskalaki Mountanou, and Thomas Benjamin Britton "Advancing characterisation with statistics from correlative electron diffraction and X-ray spectroscopy, in the scanning electron microscope" Ultramicroscopy (2020) (https://doi.org/10.1016/j.ultramic.2020.112944 & preprint https://arxiv.org/abs/1908.04084 )
...
The AstroECP module is presented in:

M. Haroon Qaiser, Lukas Berners, Robin J. Scales, Tianbi Zhang, Martin Heller, Jiri Dluhos, Sandra Korte-Kerzel, and T. Ben Britton "AstroECP: towards more practical Electron Channeling Contrast Imaging" (preprint https://arxiv.org/abs/2507.00354)

For an (incomplete) list of updates, please refer to CHANGELOG.
